...
import { getClientsForInvoice, getNextInvoiceNumber } from "@/db/queries/invoice";
...
export async function GET(request: NextRequest) {
    try {
        ...
        const [clients, nextInvoiceNumber, services, defaultTemplate, templates] = await Promise.all([
