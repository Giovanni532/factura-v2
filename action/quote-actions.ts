...
export const downloadQuoteAction = useMutation(
    ...
    async (input, { userId }) => {
        ...
        html = html.replace(/\{\{quote\.subtotal\}\}/g, templateData.quote.subtotal);
        html = html.replace(/\{\{quote\.taxRate\}\}/g, templateData.quote.taxRate);
        html = html.replace(/\{\{quote\.taxAmount\}\}/g, templateData.quote.taxAmount);
        html = html.replace(/\{\{quote\.total\}\}/g, templateData.quote.total);
        ...
        // Remplacer la section des items
